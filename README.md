...
- Source: NYC OpenData
- Link: - Link: [NYC Open Data – Restaurant Inspection Results](https://data.cityofnewyork.us/Health/DOHMH-New-York-City-Restaurant-Inspection-Results/43nn-pn8j/about_data)
...
- Link: - Link: [ACS 2024 5-year — B19013 (Median Household Income)](https://data.census.gov/table/ACSDT1Y2024.B19013?q=B19013), [ACS 2024 5-year — B11001 (Total Households)](https://data.census.gov/table?q=B11001&g=0400000US36$1400000)
- Description: Provides median household income and total household at the census tract level.

### 3. TIGER/Line Shapefiles (2022)

- Source: United States Census Bureau
- Link: [TIGER/Line Shapefiles (2022) — Census Tracts](https://www.census.gov/geographies/mapping-files/time-series/geo/tiger-line-file.2022.html)
- Description: Provides census tract boundary for NYC.

### 4. 2020 Neighborhood Tabulation Areas (NTAs) - Mapped

- Source: NYC OpenData
- Link: [NYC Open Data — 2020 Neighborhood Tabulation Areas (NTAs) – Mapped](https://data.cityofnewyork.us/City-Government/2020-Neighborhood-Tabulation-Areas-NTAs-Mapped/4hft-v355)
...
They include 3 maps, 3 scatter pots, 1 stacked bar chart, and 1 line chart:
...
Streamlit dashboard is generated using: streamlit-app/streamlit_app.py. Git Release is used when deploy the Streamlit
...
Streamlit dashboard link: https://30538-final-project-h9h7wqmhtuwhwh8nndhnv4.streamlit.app
